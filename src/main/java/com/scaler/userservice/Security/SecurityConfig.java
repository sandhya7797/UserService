...
//                .username("user")
//                .password("$2a$12$kFtriweixZu8BSy7xS/f1O.uCmmv56CQryUt3khlf99jVqrxbkXSi")//bcrpt password for "password"
//                .roles("USER")
//                .build();
//
...
//    }
    ...
    // Configures an in-memory registered client repository with an OIDC client
    //client is anyone who may want to use the authorization server. For us different microservices will be clients.
//    @Bean
...
//                //where will the person redirected after loggedin.
...
//    }
    ...
    // setting up encryption algorithm
    @Bean
    ...
    // Configures the default authorization server settings
    @Bean
